...
**Project By: CHALAMSETTI SAI BHANU PRAKASH**
  ...
  <p>
    ...
    <a href="https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/LICENSE">
...
<div align="center">
    ...
    <p align="justify"> 
      **AI-powered resume analysis:** A tool which parses information from a resume using natural language processing and finds the keywords, cluster them onto sectors based on their keywords. 
...
```bash
git clone https://github.com/2300080185/AI-Resume-Analyzer.git.git
```
...
https://github.com/2300080185/AI-Resume-Analyzer.git/blob/17e1cdb207fef62557dc394f4158bda515e541fd/App/App.py#L95
...
I've attached the <a href="https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/RESUME%20ANALYSER%20SYNOPSIS.pdf">synopsis</a> of the project
...
![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/user/1-main-screen.png?raw=true)

**Resume Analysis**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/user/2-analysis.jpg?raw=true)

**Skill Recommendation**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/user/3-recom.png?raw=true)

**Course Recommendation**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/user/4-recom.png?raw=true)

**Tips and Overall Score**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/user/5-tipsscore.png?raw=true)

**Video Recommendation**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/user/6-recom.png?raw=true)

### Feedback

**Feedback Form**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/feedback/1-form.png?raw=true)

**Overall Rating Analysis and Comment History**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/feedback/2-analytics.png?raw=true)

### Admin

**Login**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/admin/1-main-screen.png?raw=true)

**User Count and it's data**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/admin/2-user-data.png?raw=true)

**Exported csv file**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/admin/3-user-datacsv.png?raw=true)

**Feedback Data**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/admin/4-feed-data.png?raw=true)

**Pie Chart Analytical Representation of clusters**

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/admin/5-pieexp.png?raw=true)

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/admin/6-piescre.jpg?raw=true)

![Screenshot](https://github.com/2300080185/AI-Resume-Analyzer.git/blob/main/screenshots/admin/7-pielocation.png?raw=true)
